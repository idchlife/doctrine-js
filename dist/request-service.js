...
/***/ function(module, exports, __webpack_require__) {
	...
	var SuperagentRequestService = (function () {
	    ...
	    SuperagentRequestService.prototype.repositoryRequest = function (entityName, command) {
	        var args = [];
	        for (var _i = 2; _i < arguments.length; _i++) {
	            args[_i - 2] = arguments[_i];
	        }
	        return this.post(this.entryUrl + "/repository", { entityName: entityName, command: command, args: args });
	    };
